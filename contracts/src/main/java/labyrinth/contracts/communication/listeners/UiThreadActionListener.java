...
/**
 * A listener that handles a response one time with a certain action performed on the UI thread
 * @author Lukas Reinhardt
 * @version 1.0
 */
public final class UiThreadActionListener extends ActionListener
{
	//Properties
	 ...
	 */
	public UiThreadActionListener(MessageType messageType, Consumer<Object> action) { super(messageType, action); }
